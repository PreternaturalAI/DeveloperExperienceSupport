...
extension BundleInfoPlist.UTI: Encodable {
...
extension Array where Element == BundleInfoPlist.UTI {
    ...
    public func generateDocumentTypes(
        handlerRank: BundleInfoPlist.CFBundleDocumentTypes.DocumentType.HandlerRank = .owner
    ) -> [BundleInfoPlist.CFBundleDocumentTypes.DocumentType] {
...
extension UTType {
    public init(from uti: BundleInfoPlist.UTI) throws {
